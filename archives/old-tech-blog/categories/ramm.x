...
<title>ramm.x - Archive: CC Technical Blog (2007-2014) — Creative Commons on GitHub</title>
<body>
  <div class="ga-script">
...
<script type="text/javascript">
              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown ">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarCommunityDropdown">
                      ...
                      <a class="dropdown-item" href="/community/community-team/project-roles/">Community Team: Project Roles</a>
  ...
  <h2>All posts categorized "ramm.x"</h2>
