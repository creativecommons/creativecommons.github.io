...
<title>ramm.x — Creative Commons on GitHub</title>
    ...
    <nav class="navbar">
      ...
      <div class="navbar-menu">
        <div class="navbar-end">
          ...
          <div class="navbar-item has-dropdown is-hoverable">
            <a class="navbar-link is-arrowless  is-active">Archives<i
        ...
        <ul>
          ...
          <!-- Extracting the slugs of URL -->
            ...
            <!-- Active link -->
              ...
              <li><a class="link" href="/archives/old-tech-blog/categories/">
            ...
            <!-- Active link -->
              ...
              <li class="is-active"><a aria-current="page displayed">Ramm.x</a></li>
...
<div class="all-categories">
  <div class="header">
    <div class="container">
      <h1>All posts categorized "ramm.x"</h1>
      <a class="button small margin-top-bigger" href="/archives/old-tech-blog/categories/">See all categories</a>
    </div>
  </div>
      ...
      <div class="column is-one-third">
        <article class="card entry-post horizontal no-border blog-entry">
          ...
          <div class="blog-content">
            ...
            <span class="blog-author">by <a href="/archives/old-tech-blog/authors/ml/">
  ml
</a>
            on 2007-08-03</span>
            <div class="excerpt">
            ...
            <div class="column is-full">
              <nav class="footer-navigation">
                <ul class="menu">
                  ...
                  <li>
                    <a href="/community/community-team/" class="menu-item">Community Teams</a>
                  </li>
                  <li>
